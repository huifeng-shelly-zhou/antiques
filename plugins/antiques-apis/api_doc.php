	...
	$apis = array(
		( object )array(
			...
			'parameters' => array(					
					...
					'firebase_token' => 'optional; string',
					'lang' => 'optional; string',					
				),
			'response' => json_encode( array('success'=>true, 'message'=>'', 'resend_link'=>'', 'user'=>new ANTIQUES_USER), JSON_PRETTY_PRINT ),		
		),
		
		( object )array(
			'name' => 'User | Login With Other Provider Account',
			'link' => '/OX/api/user/provider/account',
			'type' => 'post',
			'headers' => array(
					'Key' => 'string: api key, example: abcederoternoc',
					'Secret' => 'string: api secret, example: abcederoternocabcederoternocabcederoternoc',										
			...
			'parameters' => array(					
					'authorize' => 'string: base64 {email:id}, example: c3RhcmxvYnN0ZXJAYWl0c29sdXRpb24uY2E6MkhYcSRCeTMlZ09sS0tKcURybUhuOG05',					
					'provider' => 'string',
		...
		( object )array(
			'name' => 'User | Lang Update',
			'link' => '/OX/api/user/lang/update',
			'type' => 'post',
			'headers' => array(
					'Key' => 'string: api key, example: abcederoternoc',
					'Secret' => 'string: api secret, example: abcederoternocabcederoternocabcederoternoc',										
		...
		( object )array(
			...
			'response' => json_encode( array('success'=>true, 'message'=>'', 'user'=>new ANTIQUES_USER), JSON_PRETTY_PRINT ),		
		),
		
		( object )array(
			'name' => 'User | Profile Update',
			'link' => '/OX/api/user/profile/update',
			'type' => 'post',
			'headers' => array(
					'Key' => 'string: api key, example: abcederoternoc',
					'Secret' => 'string: api secret, example: abcederoternocabcederoternocabcederoternoc',									
		...
		( object )array(
			'name' => 'User | Verify Email Address',
			'link' => '/OX/api/user/verify/email',
			'type' => 'post',
			'headers' => array(
					'Key' => 'string: api key, example: abcederoternoc',
					'Secret' => 'string: api secret, example: abcederoternocabcederoternocabcederoternoc',										
			...
			'parameters' => array(					
					'user_login' => 'string base64 {user_login}',
					'key' => 'string',
		...
		( object )array(
			...
			'link' => '/OX/api/user/send/verification',
			'type' => 'get',
			'headers' => array(
					'Key' => 'string: api key, example: abcederoternoc',
					'Secret' => 'string: api secret, example: abcederoternocabcederoternocabcederoternoc',										
			...
			'parameters' => array(					
					'verify' => 'string: base64 {email}, example: c2hlbGx5Lnpob3UrMTJAYWl0c29sdXRpb24uY2E=',					
				),
		...
		( object )array(
			...
			'parameters' => array(					
					'token' => 'string: token generated by /OX/api/user/login',
					'image' => 'file',
					'attachment_type' => 'string; Values: avatar or antique',
					'product_id' => 'optional; int',
					'lang' => 'optional; string'
				),
			'response' => json_encode( array('success'=>true, 'message'=>'', 'uploaded_url'=>''), JSON_PRETTY_PRINT ),		
		),		
